...
A análise de regressão linear foi significativa pelo teste F ao nível de 1% de probabilidadade (p=<0.001), indicando que existe uma relação linear entre o IPCA e ExpBovi, denotado pelos baixos valor de R² (0.92).
...
A análise de regressão linear foi significativa pelo teste F ao nível de 1% de probabilidadade (p=<0.001), indicando que existe uma relação linear entre o IPCA e ExpBovi, denotado pelos baixos valor de R² (0.85).
